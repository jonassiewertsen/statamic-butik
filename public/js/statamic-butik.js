...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_fieldtypes_moneyFieldtype__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_fieldtypes_moneyFieldtype___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_fieldtypes_moneyFieldtype__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_fieldtypes_taxFieldtype__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_fieldtypes_taxFieldtype___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__components_fieldtypes_taxFieldtype__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__partials_CreateButton__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__partials_CreateButton___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__partials_CreateButton__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__partials_PublishFormRedirect__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__partials_PublishFormRedirect___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__partials_PublishFormRedirect__);
...
Statamic.booting(function () {
    ...
    // Fieldtypes
    Statamic.$components.register('money-fieldtype', __WEBPACK_IMPORTED_MODULE_6__components_fieldtypes_moneyFieldtype___default.a);
    Statamic.$components.register('tax-fieldtype', __WEBPACK_IMPORTED_MODULE_7__components_fieldtypes_taxFieldtype___default.a);

    // Partials
    Statamic.$components.register('create-button', __WEBPACK_IMPORTED_MODULE_8__partials_CreateButton___default.a);
    Statamic.$components.register('publish-form-redirect', __WEBPACK_IMPORTED_MODULE_9__partials_PublishFormRedirect___default.a);
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DeletesListingRow_js__ = __webpack_require__(2);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stacks_Form__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stacks_Form__ = __webpack_require__(5);
    ...
    methods: {
        ...
        deleteCategory: function deleteCategory(category) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete(this.categoryDeleteRoute(category)).then(function () {
                _this3.$toast.success(__('Deleted'));
            }).catch(function (error) {
                _this3.$toast.error(error);
            });
    ...
    _c("section", { staticClass: "flex-grow" }, [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("create-button", {
            attrs: { label: "New category", classes: "bg-white ml-3" },
            on: {
              clicked: function($event) {
      ...
      _c("div", { staticClass: "publish-section" }, [
        _c("table", { staticClass: "data-table" }, [
          _c(
            "tbody",
            [
              _vm._l(_vm.updatedCategories, function(category) {
                return _c("tr", [
                  _c("th", { staticClass: "pl-2 py-1 w-1/4 text-base" }, [
                  ...
                  _c("td", [
                    _c(
                      "button",
                      {
                        staticClass: "text-red hover:text-red-light",
                        on: {
                          click: function($event) {
              ...
              _vm._v(" "),
              _vm.updatedCategories.length === 0
                ? _c("tr", [
