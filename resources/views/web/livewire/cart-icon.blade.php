<div class="b-px-2">
    <a class="b-relative b-block" href="{{ route('butik.cart') }}" rel="noopener, nofollow">
        <svg class="b-w-6" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="b-hidden b-absolute b-bg-black b-rounded-full b-w-6 b-h-6 b-border-2 b-border-white b-bottom-0 b--m-1 b-text-white b-font-bold b-flex b-justify-center b-items-center">
            {{ $total }}
        </div>
    </a>
</div>
