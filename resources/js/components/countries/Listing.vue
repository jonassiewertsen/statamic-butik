        ...
        <div class="card p-0" slot-scope="{ filteredRows: rows }">
            <data-list-table :rows="rows">
                ...
                <template slot="actions" slot-scope="{ row: collection, index }">
                    ...
                    <!-- TODO: A really nice toast notification would be great, if the country cant be deleted -->

                    <confirmation-modal
                        v-if="deletingRow !== false"
                        :title="deletingModalTitle"
                        :bodyText="__('Are you sure you want to delete this country?')"
                        :buttonText="__('Delete')"
                        :danger="true"
                        @confirm="deleteRow('/butik/settings/countries')"
